                ...
                <div className="flex items-center gap-1">
                  <div>
                    <Link
                      ...
                      className={`flex h-10 px-4 items-center justify-center rounded-md bg-[rgba(26,26,26,0.8)] text-[rgba(255,255,255,0.69)] hover:bg-[rgba(255,215,0,0.2)] hover:text-[#ffd700] transition-all duration-300 ${
                  ...
                  {Array.from({ length: Math.min(totalPages, 7) }).map((_, i) => {
                    ...
                    return (
                      <React.Fragment key={page}>
                        {i === 0 && page > 1 && (
                          <>
                            <div>
                              <Link
                                href="/blog?page=1"
                                className="flex h-10 w-10 items-center justify-center rounded-md bg-[rgba(26,26,26,0.8)] text-[rgba(255,255,255,0.69)] hover:bg-[rgba(255,215,0,0.2)] hover:text-[#ffd700] transition-all duration-300"
                              >
                                1
                              </Link>
                            </div>
                            {page > 2 && <span className="text-[rgba(255,255,255,0.5)]">...</span>}
                          </>
                        )}
                        <div>
                          <Link
                        ...
                        {i === Math.min(totalPages, 7) - 1 && page < totalPages && (
                          <>
                            {page < totalPages - 1 && <span className="text-[rgba(255,255,255,0.5)]">...</span>}
                            <div>
                              <Link
