...
const IntroduceConsultantsOnline = ({ isOpen, onClose }) => {
        ...
        <ModalContent>
          ...
          <ConsultantList>
            {/* <ConsultantItem>
              ...
              <ResumeLink
                href="/path-to-resume/Azizi_Resume.pdf"
                target="_blank"
            ...
            <ConsultantItem>
              ...
              <ResumeLink
                href="/path-to-resume/Zandian_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
                دانلود رزومه
            ...
            <ConsultantItem>
              <ConsultantName> استاد میلاد پارس چارت</ConsultantName>
...
export default IntroduceConsultantsOnline
