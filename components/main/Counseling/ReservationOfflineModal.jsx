...
import ChooseCounsult from "./ChooseCounsult"
import ConsultantInfoModal from "./ConsultantInfoModal"
import ScheduleConsultationModal from "./ScheduleConsultationModal"
import IntroduceConsultantsModal from "./IntroduceConsultantsModal"
import ConsultantScheduleModal from "./ConsultantScheduleModal"
...
const Modal = ({ isOpen, onClose }) => {
  ...
  const [isSelectConsultantModalOpen, setSelectConsultantModalOpen] = useState(false)
  ...
  return (
    <>
      <Overlay onClick={onClose}>
        <ModalContainer onClick={(e) => e.stopPropagation()}>
          ...
          <MessageBox onClick={() => setConsultantModalOpen(true)}>
            می‌خواهم همین الان با <Highlight>مشاور</Highlight> گفتگو کنم
          </MessageBox>

          <ModalButtonsContainer>
            <Button secondary onClick={() => setSelectConsultantModalOpen(true)}>
              انتخاب مشاور
            </Button>
      ...
      <ChooseCounsult isOpen={isSelectConsultantModalOpen} onClose={() => setSelectConsultantModalOpen(false)} />
